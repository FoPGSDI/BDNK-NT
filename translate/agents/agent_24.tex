...
% Sections 5.7 (cont.) boundary conditions,
%          5.8 Approximate Version of Vertical Structure,
%          5.9 Explicit Models for Disk (outer region, middle region)
% Equations (5.7.1)--(5.9.9)
% =============================================================================

%% ----------------------------------------------------------------
%% 5.7  Equations of Vertical Structure (continuation)
%% ----------------------------------------------------------------

% [Continuation from previous agent, page 432]
...
``acceleration of gravity''$) \equiv g = R^{\hat{z}}_{\phantom{\hat{z}}\hat{0}\hat{z}\hat{0}}$
%
\begin{equation}
\tag{5.7.1}
\end{equation}

(cf.\ eq.\ 5.2.24).  An explicit expression for $R^{\hat{z}}_{\phantom{\hat{z}}\hat{0}\hat{z}\hat{0}}$ can be obtained by a trans%
formation of the ``LNRF'' components, $R^{(\hat{\alpha})}_{\ (\hat{\beta})(\hat{\gamma})(\hat{\delta})}$, of the Riemann tensor as
given in Bardeen, Press and Teukolsky (1972):
%
\begin{equation}
\tag{5.7.2}
...
= \frac{M}{r^3}
  ...
  \right]
  \frac{M\,\mathscr{Q}^2\mathscr{Q}\mathscr{G}}{4\pi\,(\mathscr{E},\,\mathscr{G})\,\mathscr{E}_{\text{Causal Structure}}}
\end{equation}
...
\begin{equation}
\tag{5.7.4a}
\frac{dp}{dz} = \rho_0 \times (\text{``acceleration of gravity''})
= \rho_0\, R^{\hat{z}}_{\phantom{\hat{z}}\hat{0}\hat{z}\hat{0}}\, z
\end{equation}
...
\tag{5.7.4c}
\frac{dq^z}{dz}
= -2\sigma^{(\text{SG})}_{\varphi r}\, t_{\varphi r}
= \tfrac{3}{2}(M/r^3)^{1/2}\,t_{\varphi r}\,\mathscr{G}^{-1}\,\mathscr{Q}.
\end{equation}
...
\begin{equation}
\tag{5.7.4d$'$}
q^z = -\frac{1}{K\rho_0}\,\frac{d}{dz}\bigl(\tfrac{1}{3}bT^4\bigr).
\end{equation}
...
\tag{5.8.1a}
\bar{h}
= (\bar{p}/\rho_0)^{1/2}\,(\bar{r}/M)^{1/2}\,2\,\bar{g}^{1/2}\,\mathscr{Q}^{-1/2}\,,
\end{equation}
%
...
models.  These models are due originally to Shakura and Sunyaev~(1972)---except
for relativistic corrections, which are due to Thorne~(1973b).
...
$L \sim 10^{37}$\,ergs/sec$\,\simeq 10^{-3}M_\odot/$yr (a value that will produce
we shall express $\dot{M}_0$ in units of $10^{17}$\,g\,sec$^{-1}$, and we shall express $r$ in units of the radius of the extreme-
Kerr horizon:
%
\begin{equation}
\tag{5.9.1}
...
\end{equation}
%
for a possible supermassive hole at the center of our Galaxy ($M \sim 3 \times 10^7\,M_\odot$,
...
\begin{align}
\tag{5.9.6}
F &= (0.8 \times 10^{26}\;\text{erg/cm}^2\,\text{sec})
    (M_*^{-2}\,\dot{M}_{0*})\, r_*^{-3}\,\mathscr{Q}^{-1}\,\mathscr{G}^{-1/2}\,\mathscr{Q}, \notag \\[4pt]
\Sigma &= (9 \times 10^{2}\;\text{cm})(\alpha^{-1/10}\,M_*^{-7/10}\,\dot{M}_{0*}^{-4/5}\,\mathscr{G}^{1/2})
         \notag \\
       &\qquad \times r_*^{-17/20}\,\mathscr{G}^{-33/20}\,\mathscr{Q}^{-1/\!8}\,\mathscr{G}^{1/2}\,\mathscr{Q}^{2/5}, \notag \\[4pt]
h &= (9 \times 10^{2}\;\text{cm})(\alpha^{-1/10}\,M_*^{3/4}\,\dot{M}_{0*}^{3/20}\,\mathscr{G}^{9/8}\,\mathscr{Q}^{-11/10}\,\mathscr{G}^{1/2})\notag \\
  &\qquad \times r_*^{-33/40}\,\mathscr{G}^{-33/20}\,\mathscr{Q}^{-1/8}\,\mathscr{G}^{1/2}\,\mathscr{Q}^{2/5},
\end{align}

% [Note: The exact exponents in the outer and middle region profiles involve
%  many fractional powers of alpha, M_*, Mdot_{0*}, r_*, and the relativistic
%  correction factors Q, G. See the original text for full detail.]

\begin{align}
\rho_0 &= (8 \times 10^{-1}\;\text{g/cm}^3)
         (\alpha^{-7/10}\,M_*^{-7/10}\,\dot{M}_{0*}^{11/20})\,r_*^{-15/8}\,
         \mathscr{Q}^{11/10}\,\mathscr{G}^{-15/\!20}\,, \notag \\[4pt]
T &= (8 \times 10^{7}\;\text{K})
     (\alpha^{-1/5}\,M_*^{-1/5}\,\dot{M}_{0*}^{3/10})\,r_*^{-3/4}\,
     \mathscr{Q}^{-1/5}\,\mathscr{G}^{-3/20}\,, \notag \\[4pt]
\tau_{ff} &= (2 \times 10^{3})
            (\alpha^{-4/5}\,M_*^{-7/8}\,\dot{M}_{0*}^{-2/5}\,\mathscr{G}^{1/5})\,r_*^{21/16}\,
            \mathscr{Q}^{-2/5}\,\mathscr{G}^{1/2}\,\mathscr{Q}^{1/5}\,, \notag \\[4pt]
B &\lesssim (7 \times 10^{8}\;\text{G})
          (\alpha^{-4/5}\,M_*^{-7/10}\,\dot{M}_{0*}^{2/5})\,r_*^{-17/8}\,\mathscr{Q}^{-3/5}\,\mathscr{G}^{1/2}\,\mathscr{Q}^{1/5}\,,
\notag
\end{align}
%
\begin{align}
\frac{p^{(\text{gas})}}{p^{(\text{rad})}}
&= (0.02)(\alpha^{-1/10}\,M_*^{-1/10}\,\dot{M}_{0*}^{-1/5})\,r_*^{1/2}\,
   \mathscr{Q}^{-4/5}\,\mathscr{G}^{1/2}\,\mathscr{Q}^{-1}\,, \notag \\[4pt]
\frac{t_{ff}}{\tau_{es}} &= (0.6 \times 10^{-5})
  (M_* \dot{M}_{0*})^{3/2}\,\mathscr{Q}^{3/2}\,\mathscr{Q}^{1/2}\,\mathscr{G}^{1/2}\,\mathscr{Q}^{-1} \notag \\
&= 50(\alpha^{-4/5}\,M_*^{-9/10}\,\dot{M}_{0*}^{1/10})\,r_*^{3/2}\,
   \mathscr{Q}^{-11/20}\,\mathscr{G}^{1/4}\,\mathscr{Q}^{1/10}\,, \notag \\[4pt]
\Delta(r)
&= (0.7\;\text{sec})(\alpha^{-4/5}\,M_*^{5/8}\,\dot{M}_{0*}^{-3/10})\,r_*^{21/16}\,
   \mathscr{Q}^{-4/5}\,\mathscr{G}^{1/2}\,\mathscr{Q}^{1/2}\,\mathscr{Q}^{3/5} \notag \\
&\qquad \times \mathscr{G}^{-1/20}\,\mathscr{Q}^{-7/20}\,. \notag
\end{align}

It is worth noting that $\mathscr{Q} \to 0$ as $r \to r_{ms}$---i.e., at
the relativistic correction $\mathscr{Q}$ goes to zero smoothly at the
inner edge of the disk
$\mathscr{Q} \to 0$, $\mathscr{Q}_r \to 0$ as $r \to r_{ms}$.

The transition to the middle region occurs where $\tau_{ff}/\tau_{es} \sim 1$---i.e., at
%
\begin{equation}
\tag{5.9.7}
r_* = r_{om*} \equiv 2 \times 10^3
(M_*^{-2/3}\,\dot{M}_{0*}^{2/3})\,
\mathscr{Q}^{2/3}\,\mathscr{Q}^{-8/15}\,\mathscr{G}^{-1/3}\,\mathscr{G}^{-1/3}\,\mathscr{Q}^{2/3}.
\end{equation}
%
(5.9.7) for ``supermassive case.''
...
F &= (0.6 \times 10^{26}\;\text{erg/cm}^2\,\text{sec})
    (M_*^{-2}\,\dot{M}_{0*})\,r_*^{-3}\,\mathscr{Q}^{-1}\,\mathscr{G}^{-6/5}\,\mathscr{Q}^{-4/5}\,\mathscr{Q}^{3/5}\,, \notag \\[4pt]
\Sigma &= (5 \times 10^{3}\;\text{g/cm}^3)
         (\alpha^{-4/5}\,M_*^{2/5}\,\dot{M}_{0*}^{3/5})\,r_*^{-3/5}\,
         \mathscr{Q}^{-4/5}\,\mathscr{Q}^{21/20}\,\mathscr{Q}\,\mathscr{G}^{-6/5}\,\mathscr{Q}^{-4/5}\,\mathscr{Q}^{3/5}\,, \notag \\[4pt]
h &= (3 \times 10^{3}\;\text{cm})
    (\alpha^{-1/10}\,M_*^{-7/10}\,\dot{M}_{0*}^{1/5})\,r_*^{21/20}\,
    \mathscr{Q}_*^{-4/5}\,\mathscr{G}^{-6/5}\,\mathscr{Q}^{-4/5}\,\mathscr{Q}^{3/5}\,, \notag \\[4pt]
\rho_0 &= (10\;\text{g/cm}^3)(\alpha^{-7/10}\,M_*^{-7/10}\,\dot{M}_{0*}^{2/5})\,r_*^{-33/20}\,
         \mathscr{Q}^{-11/10}\,\mathscr{G}^{-1/5}\,\mathscr{Q}^{-4/5}\,\mathscr{Q}^{3/5}\,, \notag \\[4pt]
T &= (3 \times 10^{8}\;\text{K})
    (\alpha^{-1/5}\,M_*^{-1/5}\,\dot{M}_{0*}^{2/5})\,r_*^{-9/10}\,
    \mathscr{Q}^{-3/5}\,\mathscr{G}^{-1/5}\,\mathscr{Q}^{-4/5}\,\mathscr{Q}^{3/5}\,, \notag \\[4pt]
\tau_{es} &= (2 \times 10^{3})
            (\alpha^{-4/5}\,M_*^{1/5}\,\dot{M}_{0*}^{3/5})\,r_*^{-3/5}\,
            \mathscr{Q}^{-4/5}\,\mathscr{G}^{1/2}\,\mathscr{Q}^{1/5}\,, \notag \\[4pt]
B &\lesssim (2 \times 10^{8}\;\text{K})
          (\alpha^{-1/5}\,M_*^{-7/10}\,\dot{M}_{0*}^{2/5})\,
          r_*^{-51/40}\,\mathscr{Q}^{-1}\,\mathscr{G}^{-1/5}\,\mathscr{Q}^{-4/5}\,\mathscr{Q}^{3/5}\,, \notag
\end{align}
%
\begin{align}
\frac{p^{(\text{gas})}}{p^{(\text{rad})}}
&= (0.02)(\alpha^{-1/10}\,M_*^{-1/10}\,\dot{M}_{0*}^{-1/5})\,r_*^{1/2}\,
   \mathscr{Q}^{-4/5}\,\mathscr{G}^{1/2}\,\mathscr{Q}^{-1}\,, \notag \\[4pt]
\frac{t_{ff}}{\tau_{es}} &= (0.6 \times 10^{-5})
  (M_*\,\dot{M}_{0*})^{3/2}\,\mathscr{Q}\,\mathscr{Q}^{1/2}\,\mathscr{G}^{1/2}\,\mathscr{Q}^{-1}\,, \notag \\
r_*^{(\text{tr.})} &= (t_{ff}/\tau_{es})^{1/2} \notag \\
&= 50(\alpha^{-4/5}\,M_*^{-9/10}\,\dot{M}_{0*}^{1/10})\,r_*^{3/2}\,
   \mathscr{Q}^{-11/20}\,\mathscr{G}^{1/4}\,\mathscr{Q}^{1/10}\,, \notag \\[4pt]
\Delta(r) &= (0.7\;\text{sec})(\alpha^{-4/5}\,M_*^{5/8}\,\dot{M}_{0*}^{-3/10})\,r_*^{21/16} \notag \\
&\qquad\times \mathscr{Q}^{-4/5}\,\mathscr{G}^{1/2}\,\mathscr{Q}^{1/2}\,\mathscr{Q}^{3/5}\,\mathscr{G}^{-1/20}\,\mathscr{Q}^{-7/20}\,. \notag
\end{align}
...
\mathscr{Q}^{20/21}\,\mathscr{G}^{-36/21}\,\mathscr{G}^{-8/21}\,\mathscr{Q}^{16/21}
\end{equation}
%
