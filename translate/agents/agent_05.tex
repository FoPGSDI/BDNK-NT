...
\begin{equation}
\langle (\gamma v_\perp)^2 \rangle = \frac{2}{3}\langle v^2 \rangle = \frac{2}{3}\cdot\frac{3kT}{m_e} = \frac{2kT}{m_e}.
\tag{2.3.8}
\end{equation}
Combining this with equations~(2.3.4) and~(2.3.7), we obtain
\begin{align}
\varepsilon &= \frac{4}{3}\left(\frac{f_e\,r_0^2 c}{m_p}\right)
...
\begin{equation}
\nu_{\text{cyc}} = \frac{eB}{2\pi m_e c} = (2.79~\text{MHz})\,B_G.
\tag{2.3.10}
\end{equation}
...
\begin{align}
\varepsilon &= \frac{16}{3}\left(\frac{f_e\,r_0^2 c}{m_p}\right)
