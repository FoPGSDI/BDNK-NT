# BDNK Viscous Relativistic Hydrodynamics — Research Notes Template
...
- **Mathematical derivations show every step** — no step-skipping; each line must follow logically from the previous
...
- **Add new section** only when content is genuinely a new thread (would be a paper section)
...
- Inserting at top of documents/sections
...
- **Skipping mathematical steps** — every derivation must be fully explicit
